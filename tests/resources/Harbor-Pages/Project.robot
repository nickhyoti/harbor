...
Delete Repo
    [Arguments]  ${pro_name}  ${repo_name}
    ${element_repo_checkbox}=  Set Variable  xpath=//clr-dg-row//clr-dg-cell[contains(.,'${pro_name}/${repo_name}')]/../../..//clr-checkbox-wrapper/label[contains(@class, 'clr-control-label')] 
...
Delete Project
    [Arguments]  ${projectname}
    Navigate To Projects
    Retry Element Click  xpath=//clr-dg-row//clr-dg-cell[contains(.,'${projectname}')]/../../..//clr-checkbox-wrapper/label[contains(@class, 'clr-control-label')] 
